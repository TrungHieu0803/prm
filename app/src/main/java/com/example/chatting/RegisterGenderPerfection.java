...
public class RegisterGenderPerfection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_gender_perfection);

        Intent intent = getIntent();
        user = (Users) intent.getSerializableExtra("classUser");
